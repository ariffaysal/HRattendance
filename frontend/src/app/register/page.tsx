...
import { Wifi, ArrowRight, Loader2, Eye, EyeOff, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] text-white overflow-hidden flex items-center justify-center relative py-8">
      <AnimatedGrid />
      ...
      <div className="relative z-10 w-full max-w-md px-4 pt-20">
        <GlassCard className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Get started with Skyview</p>
          </div>
